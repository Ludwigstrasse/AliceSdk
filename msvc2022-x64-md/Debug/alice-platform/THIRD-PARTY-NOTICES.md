...
| RapidJSON | 1.1.0 | MIT；所选公共头文件不包含 JSON_checker | `licenses/rapidjson/license.txt` | <https://github.com/Tencent/rapidjson/tree/v1.1.0> |
...
| libpng | 1.6.54 | Libpng | `licenses/libpng/LICENSE` | <https://github.com/pnggroup/libpng/tree/v1.6.54> |
