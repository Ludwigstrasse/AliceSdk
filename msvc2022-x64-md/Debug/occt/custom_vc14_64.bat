...
if /I "%VCVER%" == "vc14" (
  if "%ARCH%" == "64" (
    ...
    set "TCL_DIR="
    set "TK_DIR="
    set "FREETYPE_DIR=D:/WorkSpaceForSolidDesigner/AliceThirdParty/build/occt/win/Debug/vcpkg_installed/x64-windows/bin"
    set "FREEIMAGE_DIR="
    set "EGL_DIR="
    set "GLES2_DIR="
    set "TBB_DIR=D:/WorkSpaceForSolidDesigner/AliceThirdParty/build/occt/win/Debug/vcpkg_installed/x64-windows/bin"
    set "VTK_DIR="
    set "FFMPEG_DIR="
    set "JEMALLOC_DIR="
    set "OPENVR_DIR="
