...
set_target_properties(TKCDF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKCDF.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKCDF.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKCDF )
list(APPEND _cmake_import_check_files_for_TKCDF "${_IMPORT_PREFIX}/lib/libTKCDF.so.8.0.0" )
...
set_target_properties(TKLCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKLCAF.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKLCAF.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKLCAF )
list(APPEND _cmake_import_check_files_for_TKLCAF "${_IMPORT_PREFIX}/lib/libTKLCAF.so.8.0.0" )
...
set_target_properties(TKCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKCAF.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKCAF.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKCAF )
list(APPEND _cmake_import_check_files_for_TKCAF "${_IMPORT_PREFIX}/lib/libTKCAF.so.8.0.0" )
...
set_target_properties(TKBinL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinL.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKBinL.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKBinL )
list(APPEND _cmake_import_check_files_for_TKBinL "${_IMPORT_PREFIX}/lib/libTKBinL.so.8.0.0" )
...
set_target_properties(TKXmlL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlL.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKXmlL.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKXmlL )
list(APPEND _cmake_import_check_files_for_TKXmlL "${_IMPORT_PREFIX}/lib/libTKXmlL.so.8.0.0" )
...
set_target_properties(TKBin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBin.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKBin.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKBin )
list(APPEND _cmake_import_check_files_for_TKBin "${_IMPORT_PREFIX}/lib/libTKBin.so.8.0.0" )
...
set_target_properties(TKXml PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXml.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKXml.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKXml )
list(APPEND _cmake_import_check_files_for_TKXml "${_IMPORT_PREFIX}/lib/libTKXml.so.8.0.0" )
...
set_target_properties(TKStdL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKStdL.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKStdL.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKStdL )
list(APPEND _cmake_import_check_files_for_TKStdL "${_IMPORT_PREFIX}/lib/libTKStdL.so.8.0.0" )
...
set_target_properties(TKStd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKStd.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKStd.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKStd )
list(APPEND _cmake_import_check_files_for_TKStd "${_IMPORT_PREFIX}/lib/libTKStd.so.8.0.0" )
...
set_target_properties(TKTObj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKTObj.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKTObj.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKTObj )
list(APPEND _cmake_import_check_files_for_TKTObj "${_IMPORT_PREFIX}/lib/libTKTObj.so.8.0.0" )
...
set_target_properties(TKBinTObj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinTObj.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKBinTObj.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKBinTObj )
list(APPEND _cmake_import_check_files_for_TKBinTObj "${_IMPORT_PREFIX}/lib/libTKBinTObj.so.8.0.0" )
...
set_target_properties(TKXmlTObj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlTObj.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKXmlTObj.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKXmlTObj )
list(APPEND _cmake_import_check_files_for_TKXmlTObj "${_IMPORT_PREFIX}/lib/libTKXmlTObj.so.8.0.0" )
...
set_target_properties(TKVCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKVCAF.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKVCAF.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKVCAF )
list(APPEND _cmake_import_check_files_for_TKVCAF "${_IMPORT_PREFIX}/lib/libTKVCAF.so.8.0.0" )
