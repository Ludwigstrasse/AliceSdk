...
set_target_properties(TKService PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "libTKService.so.8.0"
  )
...
set_target_properties(TKV3d PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "libTKV3d.so.8.0"
  )
...
set_target_properties(TKOpenGl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKOpenGl.so.8.0.0"
  IMPORTED_SONAME_RELEASE "libTKOpenGl.so.8.0"
  )

list(APPEND _cmake_import_check_targets TKOpenGl )
list(APPEND _cmake_import_check_files_for_TKOpenGl "${_IMPORT_PREFIX}/lib/libTKOpenGl.so.8.0.0" )
...
set_target_properties(TKMeshVS PROPERTIES
  ...
  IMPORTED_SONAME_RELEASE "libTKMeshVS.so.8.0"
  )
